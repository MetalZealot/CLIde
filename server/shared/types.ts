...
export type ProviderRuntimePermissionGateway = {
  ...
  ): Promise<ProviderInteractiveResolution> | ProviderInteractiveResolution;
...
export type FileTreeServices = {
  ...
  moveEntries(input: {
    ...
    moved: Array<{ oldPath: string; newPath: string; type: 'file' | 'directory' }>;
    skipped: Array<{ path: string; reason: 'already-in-destination' }>;
  }>;
