...
export function createAgentRouter(dependencies: AgentRouterDependencies): express.Router {
   ...
   *                        Codex models come from the selected runtime catalog, for example
   *                                      'gpt-6-astra' (current provider default), 'gpt-5.6-sol',
   *                                      'gpt-5.6-terra', 'gpt-5.6-luna', and 'gpt-5.4-mini'.
   *
   ...
   *                          Codex supports the selected model's advertised levels; current
   *                          models use subsets of 'low', 'medium', 'high', 'xhigh', 'max', 'ultra'.
