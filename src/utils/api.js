...
/**
 * CLIde's original name for "store a server-issued refreshed token and notify
 * the app". Retained as a thin alias so existing call sites keep working; the
 * validation and event dispatch live in storeAuthToken.
 * @param {unknown} token
 */
