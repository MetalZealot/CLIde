        ...
        <>
          ...
          <div className="hidden px-2 py-1.5 md:block">
            ...
            >
              ...
              <span className="min-w-0 flex-1 truncate text-sm font-normal text-blue-600 dark:text-blue-300">
                {t('version.updateAvailableNamed', { name: releaseInfo?.title || `v${latestVersion}` })}
              </span>
            </button>
          </div>
          ...
          <div className="px-3 py-1.5 md:hidden">
            ...
            >
              ...
              <span className="min-w-0 flex-1 truncate text-left text-sm font-normal text-blue-600 dark:text-blue-300">
                {t('version.updateAvailableNamed', { name: releaseInfo?.title || `v${latestVersion}` })}
              </span>
            </button>
          </div>
