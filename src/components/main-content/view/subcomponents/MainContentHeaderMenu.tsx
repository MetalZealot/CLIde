  ...
  return (
    <>
      <button
        ...
        onClick={toggle}
        className={cn(
          '-mr-2 flex h-11 w-9 flex-shrink-0 touch-manipulation items-center justify-center rounded-lg text-muted-foreground transition-colors hover:bg-accent/60 hover:text-foreground',
