...
export default function ChatPageScrollbar({ contentRef }: { contentRef: RefObject<HTMLElement> }) {
  ...
  return (
    <div
      ...
      aria-hidden="true"
      data-visible="false"
      className="pointer-events-none fixed right-0.5 top-0 z-40 w-1 rounded-full bg-foreground/40 opacity-0 transition-opacity duration-300 data-[visible=true]:opacity-100 data-[visible=true]:duration-0"
    />
  );
}
