...
| Plan | Status | Next |
|---|---|---|
| [Chat history performance](chat-history-performance.md) | not started | Phase 1: reproducible probes and acceptance budgets |
...
| [`/btw` side questions](side-questions.md) | 3/7 | Phase 3 — side-question history kept per session on the server |
