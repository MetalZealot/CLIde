...
| [Mobile bottom navigation](mobile-bottom-navigation.md) | 1/4 | Measure keyboard and bottom-inset behavior in an installed test PWA, then agree phase 3 defaults |
