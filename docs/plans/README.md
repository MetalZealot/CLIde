...
| Plan | Status | Next |
|---|---|---|
| [Phone chat text selection](mobile-chat-page-scroll.md) | 4/5 | Grayson checks phase 5 in the Chrome install of the test app, then merge when he says so |
...
| — | | |
| [Turn liveness and usage warnings](turn-liveness-and-usage-warnings.md) | 1/6 | Phase 1: log retries, errors and turn timing to the server log |
