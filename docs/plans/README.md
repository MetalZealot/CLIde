...
| Plan | Status | Next |
|---|---|---|
| [Codex 0.147 and managed native runtime](codex-0-147-managed-native-runtime.md) | 4/7 | Phase 5: resolve and select one managed native runtime for every Codex facet |
