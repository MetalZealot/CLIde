...
| Plan | Status | Next |
|---|---|---|
| [Codex 0.147 and managed native runtime](codex-0-147-managed-native-runtime.md) | 5/7 | Phase 6: expose checks and explicit runtime selection in the Codex account card |
