...
- Status: 3/4
- Next: Post-merge installed-PWA acceptance of the bar, Chat status indicator, compact menus, and Browser preview.
...
running provider session. The maintainer authorized integration after this review. Installed-PWA
acceptance of the bar/status, compact menus, and Browser preview remains pending.
