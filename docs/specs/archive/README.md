...
| [Post-v1.37 WebSocket liveness review](2026-07-30-post-v1-37-websocket-liveness-review.md) | 2026-08-06 | Fully carried into [the liveness plan](../../plans/archive/2026-08-27-websocket-liveness.md); its "why this is deferred" section is moot now v1.37 has merged. |
| [Browser MCP hardening](2026-07-29-browser-mcp-hardening.md) | 2026-08-06 | → [plan](../../plans/archive/2026-09-08-browser-mcp-hardening.md). Full tool-contract schemas and the verification matrix were dropped; regenerate them at implementation time against the then-current code. |
...
| [Typography system](2026-07-20-typography-system.md) | 2026-08-06 | → [plan](../../plans/archive/2026-08-21-typography-system.md). Near-verbatim; only the study recap was dropped. |
...
| [Post-v1.37 remaining work](2026-08-04-post-v1-37-remaining-work.md) | 2026-08-06 | Its queued items became individual plans and its ordering became [the plans board](../../plans/README.md); the two open decisions became [the ADR reassessment plan](../../plans/archive/post-v1-37-adr-reassessment.md). |
...
| [Typography study](2026-07-20-typography-study.md) | 2026-08-06 | The claude.ai-era study written without codebase context. Superseded by [the typography plan](../../plans/archive/2026-08-21-typography-system.md); read it only for the family rationale (why Figtree over Manrope, why Iosevka over JetBrains Mono). |
