...
| [Chat history performance](chat-history-performance.md) | Loading/rendering owners, measured bottlenecks and upstream adaptation limits | Phases 1–2 current through 2026-09-20; rendering work next |
