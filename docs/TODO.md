...
- [~] **Codex Chat's bundled SDK/CLI is updated to 0.147 and live-verified on 3002.** Unknown native MCP keys survive Settings edits and the reusable compatibility check is extracted; next resolve and select one managed runtime for every Codex facet. [Plan](plans/codex-0-147-managed-native-runtime.md). **L**
