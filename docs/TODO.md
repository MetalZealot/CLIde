...
- [~] **Mobile text selection and copying.** On branch `feat/mobile-chat-page-scroll`: the installed app scrolls the chat as the page, browser tabs keep the old layout, overlays lock the page behind them. Awaiting a phone re-test. [Plan](plans/mobile-chat-page-scroll.md). **M**
