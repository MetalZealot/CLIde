...
- [~] **Sidebar Activity section and collapsed-rail indicator.** Activity ordering/duplication, persistent search, footer Archive, rail status, matched 20px mobile open/close icons, and the accepted full-width mobile drawer are on `cloudcli-wt-sidebar-activity-section`; mobile nested rows now share their header's right gutter. [ADR 0030](decisions/0030-sidebar-activity-persistent-search-footer-archive.md). **S**
