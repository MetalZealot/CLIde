...
- [~] **Codex Chat's bundled SDK/CLI is updated to 0.147 and live-verified on 3002.** Unknown native MCP keys now survive Settings edits; next extract the reusable runtime compatibility check. [Plan](plans/codex-0-147-managed-native-runtime.md). **L**
