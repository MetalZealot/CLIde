...
- [~] **Codex rollout verification: the live acceptance matrix.** The 0.153.4 automated gate is green (315 checks), and its Astra default/new-Chat smoke passed. Broader live rows remain; diagnostics/runtime identity comes first because daily use never exercises it. [Conformance map](maps/codex-integration-conformance.md). **M**
