...
- [~] **Codex rollout verification: the live acceptance matrix.** The automated half is green — `npm run test:codex` passes 99 tests at Codex 0.149.1. What remains is the live subset owed after the 0.150.0 bump, Runtime identity first, since daily use never exercises it. [Conformance map](maps/codex-integration-conformance.md). **M**
