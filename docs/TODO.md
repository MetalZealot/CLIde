...
- [~] **Chat history loading, scrolling and Find remain slow.** Phases 1–4 complete: server reuse, unchanged-message rendering and stable pagination. Next: bounded payloads/lazy details; full-history Find and mounted-content limits follow. [Plan](plans/chat-history-performance.md), [evidence](maps/chat-history-performance.md). **L**
