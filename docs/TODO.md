...
- [~] **Codex Chat's bundled SDK/CLI is updated to 0.147 and live-verified on 3002.** Next preserve unknown native MCP keys through Settings edits, then extract the reusable runtime compatibility check. [Plan](plans/codex-0-147-managed-native-runtime.md). **L**
