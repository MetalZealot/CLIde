...
- [ ] **Typography overhaul** — self-hosted Figtree + Commit Mono, removing Merriweather and the Google Fonts CDN; the plan also records deferred chat reading-size presets. [Plan](plans/typography-system.md). **M**
