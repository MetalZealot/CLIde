...
- [~] **Chat history loading, scrolling and Find remain slow.** Phases 1–6 complete: server reuse, unchanged-message rendering, stable pagination, bounded payloads and Find without rendered history. Next: mounted-content limits. [Plan](plans/chat-history-performance.md), [evidence](maps/chat-history-performance.md). **L**
