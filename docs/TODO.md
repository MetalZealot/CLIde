...
- [ ] **Provider upgrade debt from the 0.3.246 / 0.150.0 audit.** Command-surface survey, mtime ordering, Codex dispositions, Cursor/OpenCode coverage. [Plan](plans/provider-upgrade-debt.md), which also records why `perTaskStopAffordance` stays undeclared. **M**
