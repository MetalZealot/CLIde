...
- [~] **Mobile text selection and copying.** Built for the Chrome install; see-through bars await the phone check; unmerged on branch `feat/mobile-chat-page-scroll`. [Plan](plans/mobile-chat-page-scroll.md), ADR 0056. **M**
