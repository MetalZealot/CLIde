...
- [~] **Mobile text selection and copying.** Verified on the phone in the Samsung Internet install; unmerged on branch `feat/mobile-chat-page-scroll`. [Plan](plans/mobile-chat-page-scroll.md), ADR 0056. **M**
