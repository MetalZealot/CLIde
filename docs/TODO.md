...
- [~] **Chat history loading, scrolling and Find remain slow.** Phases 1–3 complete: measured server reuse and unchanged-message rendering. Next: stable pagination; full-history Find and mounted-content limits follow. [Plan](plans/chat-history-performance.md), [evidence](maps/chat-history-performance.md). **L**
