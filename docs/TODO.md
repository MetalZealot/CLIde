...
- [~] **Chat history loading, scrolling and Find remain slow.** Phases 1–5 complete: server reuse, unchanged-message rendering, stable pagination and bounded payloads. Next: full-history Find, then mounted-content limits. [Plan](plans/chat-history-performance.md), [evidence](maps/chat-history-performance.md). **L**
