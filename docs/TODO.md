...
- [~] **Self-hosted dictation and read-aloud.** Voice Studio is independently owned, and the daily TTS, Voice Library, friendly-name, and Dictation flows are accepted. Next: decide whether the nearer-live dictation experiment is worthwhile. [Plan](plans/self-hosted-voice.md). **L**
