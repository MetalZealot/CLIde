...
- [~] **Codex rollout verification: the live acceptance matrix.** The 0.153.4 automated gate is green; Astra default/new Chat and mobile async-question display passed live. Broader live rows remain; diagnostics/runtime identity comes first because daily use never exercises it. [Conformance map](maps/codex-integration-conformance.md). **M**
