...
- [~] **Chat history loading, scrolling and Find remain slow.** Phase 1 complete: repeatable fixtures, Browser/server baselines and numeric targets. Next: safe server history caching; paging, rendering and search follow. [Plan](plans/chat-history-performance.md), [evidence](maps/chat-history-performance.md). **L**
