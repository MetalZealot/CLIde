...
- [~] **Sidebar Activity section and collapsed-rail indicator.** Urgency ordering, duplicate-in-project behavior, persistent search, and footer Archive are implemented per ADR 0030 on `cloudcli-wt-sidebar-activity-section`; awaiting live desktop/mobile acceptance and merge. **S**
