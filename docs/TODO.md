...
- [~] **Codex rollout verification: the live acceptance matrix.** The 0.153.4 gate and Astra default/new Chat passed; interactive question Send now/Queue awaits isolated live acceptance. Broader rows remain, with diagnostics/runtime identity first because daily use does not exercise it. [Conformance map](maps/codex-integration-conformance.md). **M**
