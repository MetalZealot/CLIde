...
- [~] **Codex Chat's bundled SDK/CLI is updated to 0.147 and live-verified on 3002.** One bundled-seeded managed runtime now serves every Codex facet; next expose checks and explicit selection in the Codex account card. [Plan](plans/codex-0-147-managed-native-runtime.md). **L**
