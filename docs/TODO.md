...
- [~] **Replace CLIde's home-grown Browser MCP with official Playwright MCP.** Phases 0-5 done; Phase 6 live on the topic server, and Claude plus Codex both drive the tools. Open: Cursor and OpenCode runs, then acceptance. [Plan](plans/browser-mcp-hardening.md), [ADR 0053](decisions/0053-browser-tools-are-official-playwright-mcp-over-http.md). **L**
